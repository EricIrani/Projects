...
%ultrasound data
b = 'C:\Users\er342145\Eric Project\Ultrasound\Experiment19(P7)\Experiment19(P7).xlsx';
%frame reduction key
c = 'C:\Users\er342145\Eric Project\Ultrasound\Experiment19(P7)\key_exp19_p7.xlsx';
...
q = 'C:\Users\er342145\Eric Project\IK\experiment19(p7)\';
...
for i = 1:5
  ...
  for j = 1:3
     ...
     for k = 1:3
       ...
       d = strcat(q,'K',ka{i},'_',aa{j},'_L_',mat2str(k),'.xlsx');

       %sheet name
       sn = strcat('K',ka{i},'_',aa{j},'_L_',mat2str(k));
       ...
       gmoco(:,50) = ((us(:,3) - 9.28)/1000); %had  -14.2 before /1000
       %subtract 72.72 mm from centroid in x direction -- convert to meters -- make 34th column
       gmoco(:,52) = ((us(:,2) - 72.72)/1000); %had -156.2 before /1000
       ...
       %new file location
       Datafolder = 'C:\Users\er342145\Eric Project\IK\experiment19(p7)';
       %new file headers?
